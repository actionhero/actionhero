...
describe('Core: i18n', function () {
  ...
  it('should should respect the content of the localization files for generic messages to connections', (done) => {
  ...
  it('should should respect the content of the localization files for api errors to connections', (done) => {
    api.i18n.determineConnectionLocale = function () { return 'en' }
  ...
  it('should should respect the content of the localization files for http errors to connections', (done) => {
    api.i18n.determineConnectionLocale = function () { return 'en' }
