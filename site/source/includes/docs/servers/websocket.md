...
You can read more about using a value like `connection.fingerprint` in an [authentication middleware](/docs#middleware) or using it as a key for [session information](/docs/examples/initializers/session.html).
