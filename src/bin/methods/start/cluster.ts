 ...
 */
export class StartCluster extends CLI {
  constructor() {
    super();
    ...
    this.inputs = {
      ...
      title: {
        required: false,
        note:
          "worker title prefix (default 'actionhero-worker-') set `--workerTitlePrefix=hostname`, your app.id would be like `your_host_name-#`"
      },
      workerTitlePrefix: {
        required: true,
